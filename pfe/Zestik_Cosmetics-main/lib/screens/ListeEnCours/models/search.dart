...
class _SearchBarScreenState extends State<SearchBarScreen> {
    Future<List<Produits>> _performSearch(String searchTerm) async {
  final response = await http.get(Uri.parse('http://192.168.1.7:3000/api/produit/search/produits/?libelle=$searchTerm'));
  ...
  Future<List<Produits>> fetchAllProduits() async {
  final response = await http.get(Uri.parse('http://192.168.1.7:3000/api/produit'));
