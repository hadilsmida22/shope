...
import 'package:ecommerce_int2/screens/category/RayonAlim.dart';
import 'package:ecommerce_int2/screens/category/RayonMenag.dart';
class CategoryCard extends StatelessWidget {
  Color begin = Color.fromARGB(255, 85, 116, 114);
  Color end = Color.fromARGB(255, 21, 189, 184);
          ...
          Column(
            ...
            children: <Widget>[
              ElevatedButton(
                ...
                onPressed :(){
                  if (categoryName == "produit alimentaire"){
                    Navigator.push(context,
                   MaterialPageRoute(builder: (context) => RayonAlimenatire()));
                  }else if(categoryName == "produits menagers"){
                    Navigator.push(context,
                   MaterialPageRoute(builder: (context) => RayonMenagers()));
                  }
