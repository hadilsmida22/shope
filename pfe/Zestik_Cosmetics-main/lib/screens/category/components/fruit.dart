...
class FruitPage extends StatelessWidget {
  ...
  Product p1 =new Product(image: 'assets/icons/datte.jpg',marque: '', libelle:'dattes',grammage: '',prix: '',Magasin: '');
  Product p2 =new Product(image:'assets/icons/fenouil.png', marque:'', libelle:'fenouil', grammage:'', prix:'',Magasin:'');
  ...
  Widget build(BuildContext context) {
   ...
   return FutureBuilder<List<Produits>>(
    future: categorieService.getProduitsByCategorie(4),
