...
import 'package:ecommerce_int2/screens/profil/confirmPwd.dart';
...
class _ForgotPasswordPageState extends State<ForgotPasswordPage> {
  TextEditingController phoneNumber = TextEditingController(text: '97255245');
  ...
  Widget build(BuildContext context) {
    ...
    Widget sendButton = Padding(
      padding: EdgeInsets.only(left: 70.0,top: 120.0),
      child: InkWell(
        onTap: () {
